...
- Last verified state: chart revision `7894c7f` was linted/rendered and Argo CD reports `Succeeded / Synced / Healthy`; FE and BE deployments are ready and public/backend read-only smoke checks return HTTP 200.
